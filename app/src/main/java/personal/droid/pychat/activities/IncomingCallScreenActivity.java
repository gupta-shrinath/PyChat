...
import personal.droid.pychat.utils.AudioPlayer;
...
public class IncomingCallScreenActivity extends BaseActivity {
    ...
    private String[] recordPermissions = {Manifest.permission.VIBRATE, Manifest.permission.CAMERA,Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE};
    ...
    void onSinchConnected() {
        ...
        if (call != null) {
            ...
            if (user != null) {
                Glide.with(this).load(user.getImage()).apply(new RequestOptions().placeholder(R.drawable.pychat_placeholder)).into(userImage1);
                Glide.with(this).load(user.getImage()).apply(RequestOptions.circleCropTransform().placeholder(R.drawable.pychat_placeholder)).into(userImage2);
            }
